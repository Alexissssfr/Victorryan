  ...
  return {
    ...
    joinGame: async function (gameId, playerId) {
      ...
      if (game && !game.player2) {
        // Si le joueur 1 essaie de rejoindre à nouveau, on vérifie son identité
        if (game.player1.id === playerId) {
          return true; // Le joueur 1 peut "rejoindre" sa propre partie
        }
...
function generateUniqueId() {
  // Générer un ID court mais unique (6 caractères alphanumériques)
